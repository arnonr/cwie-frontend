...
// Component
import ListComponent from "@/components/students/final-report/report2/ListAllActive.vue";
import CardListComponent from "@/components/students/final-report/report2/CardAllActive.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const company_items = reactive<any>([]); // form item
    ...
    const fetchItems = async () => {
      ...
      const params = {
        ...
        order: "desc",
        is_active: true,
        form_status_id: search.form_status_id
          ? search.form_status_id.id
          : "2,3,4,5,6,7,8,9,10",
      };
      ...
      Object.assign(
        ...
        data.data.map((x: any) => {
          let c = {
            id: x.company_id,
            name: x.company_detail.name,
            province_id: x.company_detail.province_id,
            count: 1,
          };
          return c;
        })
