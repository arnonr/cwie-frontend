    ...
    <table class="table table-bordered table-striped fs-8" style="width: 100%">
      ...
      <tbody v-if="items.length != 0">
        <tr v-for="(it, idx) in items" :key="idx">
          ...
          <td class="text-center">
            <a
              :href="it.ppt_report_file ? it.ppt_report_file : '#'"
              target=" _blank"
          ...
          <td class="text-center">
            <a
              :href="it.poster_report_file ? it.poster_report_file : '#'"
              target=" _blank"
              class="btn btn-success btn-icon btn-sm"
            >
              <i class="fa fa-file"></i>
          ...
          <td class="text-center">
            <a
              :href="it.report_file ? it.report_file : '#'"
              target=" _blank"
              class="btn btn-success btn-icon btn-sm"
            >
              <i class="fa fa-file"></i>
          ...
          <td>{{ convertDate(it.report_accept_at) }}</td>
          <td class="text-center">
            <span
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const headerColumn = [
      {
        column_name: "response_sended_at",
        title: "วันที่ส่งแผน",
        sort: true,
      },
      ...
      {
        column_name: "workplace_province_id",
        title: "สถานที่ปฏิบัติงาน",
        sort: true,
      },
      {
        column_name: "ppt_report_file",
        title: "ไฟล์นำเสนอ",
        sort: true,
      },
      {
        column_name: "poster_report_file",
        title: "ไฟล์ Poster",
        sort: true,
      },
      {
