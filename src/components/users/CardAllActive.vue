    ...
    <div class="row g-3">
      ...
      >
        <div
          ...
          :style="`border-color: ${it.status_detail.color} !important;`"
        >
          <div class="card-body p-5">
            ...
            <div class="mb-2">
              <span class="fw-bold">วันที่ขอเข้าใช้งาน : </span>
              <span> {{ convertDate(it.created_at) }}</span>
            </div>

            <div class="mb-2">
              <span class="fw-bold">กลุ่มผู้ใช้งาน : </span>
              <span> {{ it.group_detail.name }}</span>
            </div>
            ...
            <div class="mb-2">
              <span
                ...
                :style="`background-color: ${it.status_detail.color};`"
                >{{ it.status_detail.name }}</span
              >
            </div>
            <div class="dropdown">
              <button
