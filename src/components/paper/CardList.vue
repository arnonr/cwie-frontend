...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const headerColumn = [
      { column_name: "sended_at", title: "วันที่ส่ง", sort: true },
      { column_name: "semester_detail", title: "ปีการศึกษา", sort: true },
      { column_name: "start_date", title: "วันปฏิบัติงาน", sort: true },
      {
        column_name: "company_detail.name",
        title: "สถานประกอบการ",
        sort: true,
      },
      { column_name: "form_status_detail.name", title: "สถานะ", sort: true },
      { column_name: "manage", title: "ดูข้อมูล", sort: false },
    ];
