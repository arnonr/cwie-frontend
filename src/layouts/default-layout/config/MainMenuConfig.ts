...
const MainMenuConfig: Array<MenuItem> = [
  {
    pages: [
      ...
      {
        heading: "รายการกรรมการ",
        route: "/admin-reviewer",
        keenthemesIcon: "element-11",
        bootstrapIcon: "bi-person-badge",
      },
      {
        heading: "ข้อมูลหน้าแรก",
        route: "/admin-home-edit",
        keenthemesIcon: "element-11",
        bootstrapIcon: "bi-house",
      },
      {
        heading: "ข้อมูลเอกสารดาวน์โหลด",
        route: "/admin-document-edit",
        keenthemesIcon: "element-11",
        bootstrapIcon: "bi-files",
      },
      {
        heading: "ข้อมูลติดต่อเรา",
        route: "/admin-contact-edit",
        keenthemesIcon: "element-11",
        bootstrapIcon: "bi-telephone",
      },
    ],
  },
  //   {
